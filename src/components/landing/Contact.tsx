            ...
            <div className="space-y-12">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-600 text-white mb-6 uppercase tracking-widest text-[10px] font-bold">
                  ...
                  Southwest Ranches Raccoon Safety
                </div>
                <h2 className="text-3xl md:text-5xl font-heading font-bold text-slate-900 mb-6 uppercase tracking-tight">
                  Protect Your Home <br />
                  <span className="text-indigo-600">Raccoon control Southwest Ranches</span>
                </h2>
                <p className="text-slate-600 text-lg leading-relaxed italic font-medium">
                  Professional Southwest Ranches raccoon specialists ready to eliminate threats and secure your home from damage. 24/7 emergency response for immediate wildlife concerns.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-1">RACCOON HOTLINE</p>
                ...
                <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-1">SOUTHWEST RANCHES EXPERTS</p>
                  <p className="text-sm font-bold text-slate-900 uppercase">Southwest Ranches, FL 33330</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 text-slate-600 font-bold uppercase tracking-tight text-xs">
                  ...
                  <span>Emergency Service Area: Southwest Ranches • Davie • Weston • Cooper City</span>
                </div>
              </div>
              ...
              <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full h-14 rounded-2xl bg-slate-50 border-slate-100 px-6 font-medium text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    <option>Raccoon Trapping</option>
                    <option>Humane Exclusion</option>
                    <option>Attic Cleanup</option>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea placeholder="Describe the raccoon issues or concerns you're facing..." className="min-h-[150px] rounded-3xl bg-slate-50 border-slate-100 p-6 font-medium focus:ring-indigo-500" />
                </div>
                ...
                <p className="text-center text-slate-400 text-[10px] font-bold uppercase tracking-widest pt-4 italic">
                  Rapid Response Guaranteed in Southwest Ranches, FL
                </p>
              </form>
            </div>
